...
function getNodePosition(node) {
  ...
  function removeUrlParam(url){
    return getBloggerImageName(url.split("?")[0].split("#")[0]);
  }

  function getBloggerImageName(url){
    var front = url.substring(0, url.lastIndexOf("/"));
    front = front.substring(0, front.lastIndexOf("/"));

    // return front + "/s1600" + url.substring(url.lastIndexOf("/"));
...
//# sourceMappingURL=map/cirqle-on-blogger.js.map